...
function SetInfo (Card, HeroName, FullName, Comics, Picture, Combat, Durability, Intel, Power, Speed, Strength){
    ...
    if (Card == 1){
        CardElement.classList.add("scale-in-center")
    }
    ...
    document.getElementById(`statsCombat${Card}`).style.width = `0%`
